...
function App() {
  ...
  const {approve,transfer,balanceOf,balance,verify} = useContract();
  ...
  return (
    ...
    <button onClick={()=>{
     ...
     console.log(keccak256(concat([toUtf8Bytes("\x19Ethereum Signed Message:\n"),toUtf8Bytes(String("hello".length)),toUtf8Bytes("hello")])))
      ...
      // console.log(web3.eth.accounts.hashMessage(siweMessage))
      // console.log(web3.eth.accounts.sign("hello","0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80"))
